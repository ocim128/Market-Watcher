    ...
    <Card className="mt-4">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-muted/50 rounded-lg">
          <div>
            <label className="text-xs text-muted-foreground block mb-1">Entry Spread (|Z|)</label>
            <input
              type="number"
              step="0.5"
              min="1"
          ...
          <div>
            <label className="text-xs text-muted-foreground block mb-1">Min Correlation</label>
            <input
              type="number"
              step="0.05"
              min="0.5"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card>
                <CardContent className="pt-4">
                  ...
                  <div
                    className={`text-xl font-bold ${result.summary.totalProfitPercent >= 0 ? 'text-emerald-500' : 'text-red-500'}`}
                  >
              ...
              <Card>
                <CardContent className="pt-4">
                  ...
                  <div
                    className={`text-xl font-bold ${result.summary.winRate >= 50 ? 'text-emerald-500' : 'text-yellow-500'}`}
                  >
                        ...
                        {trade.direction === 'long_primary' ? (
                          <div className="flex flex-col text-xs">
                            <span className="text-emerald-400">
                              LONG {currentPrimaryPair.replace('USDT', '')}
                            </span>
                          ...
                          <div className="flex flex-col text-xs">
                            <span className="text-red-400">
                              SHORT {currentPrimaryPair.replace('USDT', '')}
                            </span>
                            <span className="text-emerald-400">
                              LONG {symbol.replace('USDT', '')}
                            </span>
                          </div>
                        )}
                      </td>
