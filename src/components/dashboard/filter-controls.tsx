                        ...
                        <div className="flex flex-wrap gap-2">
                            {SIGNAL_QUALITIES.map((quality) => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-full text-xs transition-colors ${filters.signalQualities.includes(quality)
                        ...
                        <div className="flex flex-wrap gap-2">
                            {REGIMES.map((regime) => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-full text-xs transition-colors ${filters.regimes.includes(regime)
                                            ? "bg-primary text-primary-foreground"
                                            : "bg-secondary text-muted-foreground hover:text-foreground"
                                        }`}
                                >
